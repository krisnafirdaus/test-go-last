...
func InitRoute(e *echo.Echo) {
	...
	// Menambahkan rute untuk Post
	auth.GET("/posts", controllers.GetPostsController)
	auth.POST("/posts", controllers.CreatePostController)

	auth.GET("/posts/:post_id/comments", controllers.GetCommentsByPostController)
	auth.POST("/posts/:post_id/comments", controllers.AddCommentController)
}
